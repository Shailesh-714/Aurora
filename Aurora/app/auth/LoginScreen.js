...
const SPACING = 10;
const ITEM_SIZE = Platform.OS === "ios" ? width * 0.72 : width * 0.35;
  ...
  return (
    <SafeAreaView style={{ flex: 1, alignItems: "center", minHeight: height }}>
      ...
      >
        ...
        >
          <Image
            source={optionList[providerId + 1].icon}
            style={{ width: 20, height: 20 }}
          />
          <Text style={{ fontWeight: "500", fontSize: 15 }}>
            {optionList[providerId + 1].name}
          </Text>
        </View>
        <View
          style={{
        ...
        >
          <View style={{ marginTop: 10 }}>{authOptions[providerId]}</View>
        </View>
      </Animated.View>
      <View style={{ flex: 1 }}>
        <Animated.FlatList
